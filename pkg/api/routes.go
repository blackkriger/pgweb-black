...
func SetupRoutes(router *gin.Engine) {
	...
	api.POST("/tables/:table/update", requireSameOrigin(), UpdateTableRow)
	api.POST("/tables/:table/delete", requireSameOrigin(), DeleteTableRow)
	api.POST("/tables/:table/bulk_delete", requireSameOrigin(), DeleteTableRows)
	api.POST("/tables/:table/export_rows", requireSameOrigin(), ExportTableRows)
	api.GET("/tables_stats", GetTablesStats)
	api.GET("/diagram", GetSchemaDiagram)
